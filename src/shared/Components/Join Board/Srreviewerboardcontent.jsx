...
// Array of Sr. Reviewer Board members with their details
const srReviewerBoard = [
    {
        id: '31',
    ...
    // More Sr. Reviewer Board members...
];

export default function Srreviewerboardcontent() {
    ...
    return (
        <div className="w-full p-4 mt-7">
            <div className="flex items-center justify-between mb-7">
                <h3 className="md:text-3xl text-2xl font-semibold text-orange-500 text-nowrap">Sr. Reviewer Board</h3>
