...
// Array of editorial board members with their details
...
export default function Editorialboardcontent() {
    ...
    return (
        <div className="w-full p-4 mt-7">
            <div className="flex items-center justify-between mb-7">
                <h3 className="md:text-3xl text-2xl font-semibold text-orange-500 text-nowrap">Editorial Board</h3>
