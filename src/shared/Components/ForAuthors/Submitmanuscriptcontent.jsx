    ...
    <form onSubmit={handleSubmit} className="space-y-6 mt-7">
      ...
      <div className="">
        <label className="">
          ...
          <span className="text-red-500">(Add multiple keywords separated by commas)</span>
        </label>
        <textarea
          name="keywords"
      ...
      <div className="">
        <label className="">
          Upload the Manuscript <span className="text-red-500">*</span>{" "}
          <span className="text-red-500">(File Type: doc, docx & Max file size: 5 Mb)</span>
        </label>
        <input
          type="file"
          name="manuscriptFile"
      ...
      <p className="text-sm">
        If you face any difficulty during paper submission, please send your paper with all details
        like Title, Research Area, All authors&apos; names, email id, institute name, mobile no, Address
        with pincode, country to:{" "}
      </p>
    </form>
  );
}
